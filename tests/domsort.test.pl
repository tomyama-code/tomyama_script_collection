...
subtest qq{Error path} => sub{
    ...
    $t = tests::Command->new( qq{./domsort "NON-EXISTENT-FILES"} );
...
subtest qq{Normal} => sub{
    ...
    $t = tests::Command->new( qq{./domsort "$TFILE" | awk '{print(\$1)}'} );
    ...
    #2   12.34.56.78  W.X.Y.Z.CO.JP     user2@W.X.Y.Z.CO.JP     044-1234-568
    #1   12.34.56.90  w.x.y.z.co.jp     user1@w.x.y.z.co.jp     03-1234-5678
    $t = tests::Command->new( qq{./domsort -k 2 "$TFILE" | awk '{print(\$1)}'} );
    ...
    #1   12.34.56.90  w.x.y.z.co.jp     user1@w.x.y.z.co.jp     03-1234-5678
    #2   12.34.56.78  W.X.Y.Z.CO.JP     user2@W.X.Y.Z.CO.JP     044-1234-568
    $t = tests::Command->new( qq{./domsort -k 3 "$TFILE" | awk '{print(\$1)}'} );
    ...
    #1   12.34.56.90  w.x.y.z.co.jp     user1@w.x.y.z.co.jp     03-1234-5678
    #2   12.34.56.78  W.X.Y.Z.CO.JP     user2@W.X.Y.Z.CO.JP     044-1234-568
    $t = tests::Command->new( qq{./domsort -k 4 "$TFILE" | awk '{print(\$1)}'} );
    ...
    #9   12.34.55.9   abc.com           user9@abc.com           044-1234-765
    #6   12.34.8.9    X.Y.Z.CO.JP       user6@X.Y.Z.CO.JP       08-03-1234-5678
    $t = tests::Command->new( qq{./domsort -k 5 "$TFILE" | awk '{print(\$1)}'} );
    ...
    #8   12.34.55.78  mail1.abc.com     user8@mail1.abc.com     044-123-7654
    #6   12.34.8.9    X.Y.Z.CO.JP       user6@X.Y.Z.CO.JP       08-03-1234-5678
    $t = tests::Command->new( qq{./domsort -dk 5 "$TFILE" | awk '{print(\$1)}'} );
...
subtest qq{-f  Force case sensitivity.} => sub{
    ...
    #4   12.34.8.90   x.y.z.co.jp       user4@x.y.z.co.jp       0123-111-222
    #1   12.34.56.90  w.x.y.z.co.jp     user1@w.x.y.z.co.jp     03-1234-5678
    $t = tests::Command->new( qq{./domsort -fk 3 "$TFILE" | awk '{print(\$1)}'} );
    $t->exit_is( 0, qq{./domsort -fk 3 "$TFILE" | awk '{print(\$1)}'} );
    $t->stdout_is( qq{7\n10\n3\n6\n2\n5\n9\n8\n4\n1\n}, "Case-sensitive sorting by domain name" );
    $t->stderr_is( qq{}, qq{STDERR is silent.} );
    undef( $t );

    $t = tests::Command->new( qq{./domsort -rfk 3 "$TFILE" | awk '{print(\$1)}'} );
...
subtest qq{-r  Reverse the result of comparisons.} => sub{
    ...
    #10  12.34.6.100  MAIL1.ABC.COM     USER10@MAIL1.ABC.COM    044-123-5678
    #1   12.34.56.90  w.x.y.z.co.jp     user1@w.x.y.z.co.jp     03-1234-5678
    $t = tests::Command->new( qq{./domsort -r "$TFILE" | awk '{print(\$1)}'} );
    ...
    #6       12.34.8.9       X.Y.Z.CO.JP     user6@X.Y.Z.CO.JP       08-03-1234-5678
    #10      12.34.6.100     MAIL1.ABC.COM   USER10@MAIL1.ABC.COM    044-123-5678
    $t = tests::Command->new( qq{./domsort -rk 2 "$TFILE" | awk '{print(\$1)}'} );
    ...
    #7   12.34.55.90  FREEMAIL.ABC.COM  user7@FREEMAIL.ABC.COM  03-1234-8765
    #9   12.34.55.9   abc.com           user9@abc.com           044-1234-765
    $t = tests::Command->new( qq{./domsort -rk 3 "$TFILE" | awk '{print(\$1)}'} );
    ...
    #1   12.34.56.90  w.x.y.z.co.jp     user1@w.x.y.z.co.jp     03-1234-5678
    #2   12.34.56.78  W.X.Y.Z.CO.JP     user2@W.X.Y.Z.CO.JP     044-1234-568
    $t = tests::Command->new( qq{./domsort -rk 4 "$TFILE" | awk '{print(\$1)}'} );
    ...
    #1       12.34.56.90     w.x.y.z.co.jp   user1@w.x.y.z.co.jp     03-1234-5678
    #4       12.34.8.90      x.y.z.co.jp     user4@x.y.z.co.jp       0123-111-222
    $t = tests::Command->new( qq{./domsort -rk 5 "$TFILE" | awk '{print(\$1)}'} );
    ...
    #1   12.34.56.90  w.x.y.z.co.jp     user1@w.x.y.z.co.jp     03-1234-5678
    #4   12.34.8.90   x.y.z.co.jp       user4@x.y.z.co.jp       0123-111-222
    $t = tests::Command->new( qq{./domsort -drk 5 "$TFILE" | awk '{print(\$1)}'} );
...
subtest qq{-t <SEP>} => sub{
    ...
    #8   12.34.55.78  mail1.abc.com     user8@mail1.abc.com     044-123-7654
    #9   12.34.55.9   abc.com           user9@abc.com  044-1234-765
    $t = tests::Command->new( qq{./domsort -t "\t" "$TFILE" | awk '{print(\$1)}'} );
...
subtest qq{Input data from STDIN} => sub{
    ...
    #1   12.34.56.90  w.x.y.z.co.jp     user1@w.x.y.z.co.jp     03-1234-5678
    #2   12.34.56.78  W.X.Y.Z.CO.JP     user2@W.X.Y.Z.CO.JP     044-1234-568
    $t = tests::Command->new( qq{cat "$TFILE" | ./domsort -k 3 | awk '{print(\$1)}'} );
...
subtest qq{-h, --help} => sub{
    ...
    $t = tests::Command->new( qq{./domsort -h} );
    $t->exit_is( 0, qq{./domsort -h} );
    $t->stdout_like( qr/^Usage: domsort / );
    $t->stderr_is( qq{}, qq{STDERR is silent.} );
    undef( $t );

    $t = tests::Command->new( qq{./domsort --help} );
...
subtest qq{-v, --version} => sub{
    ...
    $t = tests::Command->new( qq{./domsort -v} );
    ...
    $t = tests::Command->new( qq{./domsort --version} );
