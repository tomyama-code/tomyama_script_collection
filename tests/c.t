...
#    $t = tests::Tester->run_cmd( qq{./c 'geo_distance_km( deg2rad( -69.00439, 39.5822, -77.3169444444444, 39.7033333333333 ), 1 )'} );
...
#    undef( $t );
#
#    $t = tests::Tester->run_cmd( qq{./c 'geo_distance_km( deg2rad( -69.00439, 39.5822, -77.3169444444444, 39.7033333333333 ), 2 )'} );
...
#    undef( $t );
    ...
    $t = tests::Tester->run_cmd( qq{./c 'sec2dhms( local2epoch( 2030, 1, 1 ) - now )'} );
